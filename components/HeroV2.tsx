...
const HeroV2: React.FC = () => (
  <section className="relative mb-12 mt-4 overflow-hidden rounded-[2.5rem] border border-[#e8decd] bg-[#fffdfa] px-6 py-8 text-[#1d3d6d] shadow-[0_20px_48px_rgba(65,51,31,0.12)] sm:mb-16 sm:px-10 sm:py-11 lg:grid lg:grid-cols-[0.95fr_1.05fr] lg:gap-10 lg:px-12">
    ...
    <div className="relative mt-9 lg:mt-0 lg:flex lg:items-center"><div className="w-full rounded-[2rem] border border-[#dbe8f5] bg-white/85 p-5 shadow-[0_14px_32px_rgba(29,61,109,0.12)] backdrop-blur-sm sm:p-7"><div className="mb-5 flex items-center justify-between border-b border-slate-100 pb-4"><span className="text-[10px] font-black tracking-[0.2em] text-blue-500">CAP EXAM COMPASS</span><span className="inline-flex items-center gap-1.5 text-xs font-bold text-amber-600"><i className="h-2 w-2 rounded-full bg-amber-400" />會考倒數中</span></div><p className="mb-5 text-center text-sm font-bold text-slate-500">距離會考還有</p><CountdownTimerV2 /></div></div>
  </section>
);
