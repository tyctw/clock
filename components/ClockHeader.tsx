...
const ClockHeader: React.FC<ClockHeaderProps> = ({ isMenuOpen, onMenuToggle }) => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      setIsAnnouncementVisible(currentScrollY <= 16 || currentScrollY < previousScrollY);
